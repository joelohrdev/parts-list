<div class="container mx-auto grid grid-cols-5 gap-4 bg-white px-8 py-6 rounded-lg shadow-lg">
    <div class="col-span-1 self-center text-left">
        <h3 class="font-semibold text-lg">New Part</h3>
    </div>
    <div class="col-span-4">
        <form class="grid grid-cols-4 gap-4">
            ...
            <div class="col-span-1">
                <button type="submit" wire:click="store()"  class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 border-4 text-white py-3 px-4 rounded">Submit</button>
            </div>
        </form>
    </div>
</div>
